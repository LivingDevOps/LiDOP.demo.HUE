  ...
  post { 
    always { 
      script {
        ...
        currentBuild.description = "goto <a href=${BASE_URL}/port/9100/>App</a>"
    ...
    success {
      httpRequest authentication: 'lidop', ignoreSslErrors: true, responseHandle: 'NONE', url: "${BASE_URL}/port/1880/jenkins/success"
    }
